package academy.digitallab.customerservice.controller;

import academy.digitallab.customerservice.entity.Customer;
import academy.digitallab.customerservice.entity.Region;
import academy.digitallab.customerservice.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<List<Customer>> listAllCustomers(@RequestParam(name = "regionId" , required = false) Long regionId ) {
        ...
        if (null ==  regionId) {
            ...
            customers = customerService.getByRegion(Region);
            if ( null == customers ) {
